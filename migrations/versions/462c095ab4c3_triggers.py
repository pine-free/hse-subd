...
Revision ID: 462c095ab4c3
Revises: f01015a2002b
Create Date: 2026-03-08 19:59:17.026126
...
revision: str = '462c095ab4c3'
down_revision: Union[str, Sequence[str], None] = 'f01015a2002b'
...
def upgrade() -> None:
    ...
    op.execute("""CREATE ROLE "bartenders" WITH NOSUPERUSER NOCREATEDB NOCREATEROLE INHERIT LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'bartenders';""")
    ...
    op.execute("""CREATE ROLE "security" WITH NOSUPERUSER NOCREATEDB NOCREATEROLE INHERIT LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'security';""")
    ...
    op.execute(sa.text("""GRANT SELECT ON TABLE "card" TO "players";"""))
...
def downgrade() -> None:
    ...
    op.execute(sa.text("""REVOKE SELECT ON TABLE "card" FROM "players";"""))
